...
\usepackage{xr}
 \externaldocument{PaperAccepted}
...
{\setstretch{1}
\input{../output/tables/cpi_gdp_current_future_sdtest_robvar}
}
...
{\setstretch{1}
	\input{../output/tables/emerging_advanced_sum}
}

%%%%%%% ERRORS

{\setstretch{1}
\input{../output/tables/tab_stderr_rob}
}

{\setstretch{1}
\input{../output/tables/tab_errors_rob}
}

{\setstretch{1}
\input{../output/tables/tab_updating_rob}
}

{\setstretch{1}
\input{../output/tables/tab_updating_errors_app_small}
}
...
%%%%%%% BIASES / INFORMATION
	...
	\begin{landscape}% Landscape page
		\enlargethispage{1em}
\input{../output/tables/tab_rob_BGMS}
	\end{landscape}

	\begin{landscape}% Landscape page
		\enlargethispage{1em}
\input{../output/tables/tab_rob_overextr}
	\end{landscape}
	
	\begin{landscape}% Landscape page
		\enlargethispage{1em}
\input{../output/tables/tab_rob_past_consensus}
	\end{landscape}	

	\begin{landscape}% Landscape page
		\enlargethispage{1em}
\input{../output/tables/tab_rob_last_vintage}
	\end{landscape}	
	
	%\begin{landscape}% Landscape page
		%\enlargethispage{1em}
%\input{../output/tables/tab_rob_local}
	%\end{landscape}	
	
	\begin{landscape}% Landscape page
		\enlargethispage{1em}
\input{../output/tables/tab_rob_bias}
	\end{landscape}	
	
	\begin{landscape}% Landscape page
		\enlargethispage{1em}
\input{../output/tables/tab_rob_consensus}
	\end{landscape}

	\begin{landscape}% Landscape page
		\enlargethispage{1em}
\input{../output/tables/tab_rob_FE}
	\end{landscape}

	\begin{landscape}% Landscape page
		\enlargethispage{1em}
\input{../output/tables/tab_rob_disag}
	\end{landscape}	
	
	\begin{landscape}% Landscape page
		\enlargethispage{1em}
\input{../output/tables/tab_r3}
	\end{landscape}	
%%%%%%% DETERMINANTS

\input{../output/tables/error_reg_labs_cs_ind}

\input{../output/tables/FE_reg_mg}
...
%\input{Sections/modelEstimation}
