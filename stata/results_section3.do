...
generates results for section 3
...
* about half of the observations are generated by a forecaster that provides forecasts for both local and foreign countries in a given period
sum locfor, det
